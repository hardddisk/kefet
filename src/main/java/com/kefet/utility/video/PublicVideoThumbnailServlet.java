 ...
 */
@WebServlet(name = "PublicVideoThumbnailServlet", urlPatterns = {"/thumbnail"})
public class PublicVideoThumbnailServlet extends HttpServlet {
	
	private static Logger log = Logger.getLogger(PublicVideoThumbnailServlet.class);
	private static final String CLASS_NAME = "PublicVideoThumbnailServlet ";
   ...
   //		  HttpSession session = (HttpSession) facesContext.getExternalContext().getSession(false);
	...
	//	  List videoListCarousel = (List)session.getAttribute("videoListCarousel");
        ...
        String vidthumb = request.getParameter("vidthumb");
       
        
        log.info(CLASS_NAME+"---vidthumb-----"+vidthumb);
        ...
        directoriesLocationThmb+=vidthumb;
        ...
        if (directoriesLocationThmb != null) {
            // Strip "../" and "..\" (avoid directory sniffing by hackers!).
        	directoriesLocationThmb = directoriesLocationThmb.replaceAll("\\.+(\\\\|/)", "");
        } else {
     ...
     // Check if file name is supplied to the request.
      ...
      //  directoriesLocationThmb=directoriesLocationThmb+videoLocation+"/";
        try{
        	...
        	directoriesLocationThmb = URLDecoder.decode(directoriesLocationThmb, "UTF-8");
             imageFile = new File(directoriesLocationThmb);
        ...
        String contentType = URLConnection.guessContentTypeFromName(directoriesLocationThmb);
/*
...
*/
        ...
        try {
            ...
            response.setHeader(
                "Content-disposition", "inline; filename=\"" + directoriesLocationThmb + "\"");
